...
const ProductForm = ({ disabled,bannerMessage,bannerStatus,setBannerMessage,handleChange,handleSubmit,formState,formProductState,selectProduct,plan,updatedProducts,fetcher,shopID,templateId} ) => {
                    ...
                    <div style={{paddingLeft:'1rem',paddingRight:'1rem'}}>
                        <fieldset disabled={disabled} style={{ border: "none", padding: 0 }}>
                            ...
                            <div style={{ marginBottom: '1rem' }}>
                                <TextField label="Estimated Usage Days " type="number" name="date" value={formState.date} onChange={handleChange} disabled={disabled} autoComplete="off" />                    
                            </div>
